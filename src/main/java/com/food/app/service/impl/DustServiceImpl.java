...
public class DustServiceImpl implements DustService {
	...
	public List<Object> dustList(String area) throws UnsupportedEncodingException {
		...
		foodVO.setDustFood(dust_food[i]);

		String dust_queryString = naverService.queryString(area, dust_food[i]);
		List<Object> naverRainList = naverService.getNaver(dust_queryString);
